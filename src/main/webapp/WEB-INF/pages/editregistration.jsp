...
<head>
    ...
    <script type="text/javascript">
        function generateStudentTemplate() {
            ...
            if (i < 7) {
                ...
                $clone
                        ...
                        .find('[name="studentNodeList[0].ageRange"]').val('0').attr('name', 'studentNodeList[' + i + '].ageRange').attr('id', 'ageRange' + i).end()
        ...
        $(document).ready(function () {
            ...
            $("#ageRange${count.index}").val("${element.ageRange}");
                    ...
                    <div class="panel-body" id="consentInfoTemplate">
                        ...
                        <div>
                            ...
                            <i><b>Event/Activity:</b> Blaze-Grace Lal Seminar<br>
                                <b>Date:</b> <span id="dateInConsentForm">${parentNodeForm.day}</span></i><br>
                            <b>Time:</b> 9.30 AM to 4.00 PM</i><br>
                            <b>Venue:</b> <span
                                id="venueInConsentForm">${parentNodeForm.venue}&nbsp;&nbsp;${parentNodeForm.venueAddress}</span></i>
                            <br>
